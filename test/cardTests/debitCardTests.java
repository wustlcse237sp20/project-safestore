...
class debitCardTests {
	...
	void testValidateCardNumber() {
		...
		for (int i = 0; i < testCases.length; ++i) {
			assertEquals(expectedResults[i], DebitCard.validateCardNumber(testCases[i]));
		}
	...
	void testValidateCardExpDate() {
		...
		for (int i = 0; i < testCases.length; ++i) {
			assertEquals(expectedResults[i], DebitCard.validateExpirationDate(testCases[i]));
		}
	}
	...
	void testValidateCvv() {
		...
		for (int i = 0; i < testCases.length; ++i) {
			assertEquals(expectedResults[i], DebitCard.validateCvv(testCases[i]));
		}
	}
	...
	void testValidatePin() {
		...
		for (int i = 0; i < testCases.length; ++i) {
			assertEquals(expectedResults[i], DebitCard.validatePin(testCases[i]));
		}
	}
	
	@Test
	void testAddDebitCardValidParams() {
		System.out.println("RUNNING TEST: testAddDebitCardValidParams");
		DebitCard testValidCard = new DebitCard(testUser, "testNickname", "123456789012345", "04/23", "123", "1234", testAddress);
		try {
			assertTrue(testValidCard.addCard(databaseConnection));
			Dao<DebitCardEntity, String> debitCardDao = DaoManager.createDao(databaseConnection, DebitCardEntity.class);
			debitCardDao.delete(testValidCard.getDebitCardEntity());
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
	...
	@Test
	void testAddDebitInvalidNumber() {
		System.out.println("RUNNING TEST: testAddDebitCardValidParams");
		DebitCard testInvalidCard = new DebitCard(testUser, "testNickname", "1234567890", "04/23", "123", "1234", testAddress);
		try {
			testInvalidCard.addCard(databaseConnection);
			Dao<DebitCardEntity, String> debitCardDao = DaoManager.createDao(databaseConnection, DebitCardEntity.class);
			debitCardDao.delete(testInvalidCard.getDebitCardEntity());
		} catch (Exception e) {
			String expectedMessage = "Card number not in the correct format";
	...
	@Test
	void testAddDebitInvalidExpDate() {
		System.out.println("RUNNING TEST: testAddDebitInvalidExpDate");
		DebitCard testInvalidCard = new DebitCard(testUser, "testNickname", "123456789012345", "15/23", "123", "1234", testAddress);
		try {
			testInvalidCard.addCard(databaseConnection);
			Dao<DebitCardEntity, String> debitCardDao = DaoManager.createDao(databaseConnection, DebitCardEntity.class);
			debitCardDao.delete(testInvalidCard.getDebitCardEntity());
		} catch (Exception e) {
			String expectedMessage = "Expiration date not in the correct format";
			String actualMessage = e.getMessage();
			assertEquals(expectedMessage, actualMessage);
		}
	}
	...
	@Test
	void testAddDebitInvalidCvv() {
		System.out.println("RUNNING TEST: testAddDebitInvalidCvv");
		DebitCard testInvalidCard = new DebitCard(testUser, "testNickname", "123456789012345", "12/23", "12343", "1234", testAddress);
		try {
			testInvalidCard.addCard(databaseConnection);
			Dao<DebitCardEntity, String> debitCardDao = DaoManager.createDao(databaseConnection, DebitCardEntity.class);
			debitCardDao.delete(testInvalidCard.getDebitCardEntity());
		} catch (Exception e) {
			String expectedMessage = "CVV not in the correct format";
			String actualMessage = e.getMessage();
			assertEquals(expectedMessage, actualMessage);
		}
	}
	...
	@Test
	void testAddDebitInvalidPin() {
		System.out.println("RUNNING TEST: testAddDebitInvalidPin");
		DebitCard testInvalidCard = new DebitCard(testUser, "testNickname", "123456789012345", "12/23", "1234", "12a4", testAddress);
		try {
			testInvalidCard.addCard(databaseConnection);
			Dao<DebitCardEntity, String> debitCardDao = DaoManager.createDao(databaseConnection, DebitCardEntity.class);
			debitCardDao.delete(testInvalidCard.getDebitCardEntity());
		} catch (Exception e) {
			String expectedMessage = "Pin not in the correct format";
			String actualMessage = e.getMessage();
			assertEquals(expectedMessage, actualMessage);
		}
	}
